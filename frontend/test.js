...
REDIPS.drag = function() {
        ...
        for (e = da = 1; a < f.length; a++)
            if (0 === f[a].redips.nestedLevel) {
                ...
                for (b = 0; b < c.length; b++)
                    -1 < c[b].className.indexOf("redips-nolayout") || (c[b].redips.nestedGroup = e,
    ...
    Ea = function(a) {
        ...
        b.touches ? (a = Z = b.touches[0].clientX,
        d = aa = b.touches[0].clientY) : (a = Z = b.clientX,
        d = aa = b.clientY);
        Wa = a;
        Xa = d;
        la = !1;
        ...
        (C = k.redips.container,
        u());
        -1 === k.className.indexOf("row") ? REDIPS.drag.mode = v = "cell" : (REDIPS.drag.mode = v = "row",
        ...
        C.onselectstart = function(a) {
            b = a || window.event;
            if (!Ka(b))
                return b.shiftKey && document.selection.clear(),
                !1
        }
        ;
        return !1
    ...
    Ra = function(a) {
        ...
        for (a = 0; a < f.length; a++)
            f[a].redips.nestedGroup === b && (f[a].redips.sort = 100 * da + f[a].redips.nestedLevel);
        f.sort(function(a, b) {
    ...
    Na = function(a, b, c) {
        ...
        q = function(a) {
            var b;
            void 0 !== a.redips && a.redips.emptyRow ? wa(a, "empty", REDIPS.drag.style.rowEmptyColor) : (b = B("TABLE", a),
        ...
        g) && (!d && -1 < n.target.className.indexOf(REDIPS.drag.trash.className) ? t ? REDIPS.drag.event.rowDeleted() : REDIPS.drag.trash.questionRow ? confirm(REDIPS.drag.trash.questionRow) ? (q(e),
        REDIPS.drag.event.rowDeleted()) : (delete p.redips.emptyRow,
        REDIPS.drag.event.rowUndeleted()) : (q(e),
        REDIPS.drag.event.rowDeleted()) : (m < a.rows.length ? l === D ? g > m ? fa.insertBefore(b, h) : fa.insertBefore(b, h.nextSibling) : "after" === REDIPS.drag.rowDropMode ? fa.insertBefore(b, h.nextSibling) : fa.insertBefore(b, h) : (fa.appendChild(b),
        h = a.rows[0]),
        h && h.redips && h.redips.emptyRow ? a.deleteRow(h.rowIndex) : "overwrite" === REDIPS.drag.rowDropMode ? q(h) : "switch" !== REDIPS.drag.rowDropMode || t || (A.insertBefore(h, e),
    ...
    ga = function(a) {
        ...
        if (!t || "cell" !== v || null  !== l && null  !== h && null  !== m)
            if (null  === l || null  === h || null  === m)
                ...
                ba(l, h, m, ca),
                c = l,
                d = h) : null  === x || null  === z || null  === E ? (b = f[D],
                ...
                if ("row" === v)
                    ...
                    if (t && D === l && L === h && X === m)
                    ...
                    else if (t && !1 === REDIPS.drag.clone.drop && (a < b.redips.offset[3] || a > b.redips.offset[1] || e < b.redips.offset[0] || e > b.redips.offset[2]))
                        k.parentNode.removeChild(k),
                        --W[p.id],
                        REDIPS.drag.event.notCloned();
                        ...
                        REDIPS.drag.trash.question ? setTimeout(function() {
                            confirm(REDIPS.drag.trash.question) ? Fa() : (t || (f[D].rows[L].cells[X].appendChild(k),
                            y()),
                            REDIPS.drag.event.undeleted())
                        }, 20) : Fa();
                    else if ("switch" === REDIPS.drag.dropMode)
                        if (a = REDIPS.drag.event.droppedBefore(n.target),
                        !1 === a)
                            ma(!1);
                        else {
                            k.parentNode.removeChild(k);
                            ...
                            c = b.length;
                            for (a = 0; a < c; a++)
                                void 0 !== b[0] && (REDIPS.drag.objOld = p = b[0],
                        ...
                        "overwrite" === 
                        REDIPS.drag.dropMode ? (a = REDIPS.drag.event.droppedBefore(n.target),
                        !1 !== a && ja(n.target)) : a = REDIPS.drag.event.droppedBefore(n.target),
                        ma(a);
                else
                    REDIPS.drag.event.notMoved();
    ...
    ma = function(a) {
        ...
        if (!1 !== a) {
            ...
            t && (REDIPS.drag.event.clonedDropped(n.target),
            sa(p, -1))
        } else
            t && k.parentNode && k.parentNode.removeChild(k)
    }
    ;
    Y = function(a, b) {
        !1 === b ? (a.onmousedown = null ,
        a.ontouchstart = null ,
        a.ondblclick = null ) : (a.onmousedown = Ea,
        a.ontouchstart = Ea,
        a.ondblclick = Qa)
    }
    ;
    ...
    ha = function(a) {
        ...
        a.touches ? (d = Z = a.touches[0].clientX,
        e = aa = a.touches[0].clientY) : (d = Z = a.clientX,
        e = aa = a.clientY);
        c = Math.abs(Wa - d);
        g = Math.abs(Xa - e);
        if (!Aa) {
            if ("cell" === v && (ea || !0 === REDIPS.drag.clone.keyDiv && Oa))
                ...
                if ("row" === v) {
                    if (ea || !0 === REDIPS.drag.clone.keyRow && Oa)
                        t = !0;
                    REDIPS.drag.objOld = p = k;
                    REDIPS.drag.obj = k = ka(k);
                    k.style.zIndex = 999
        ...
        Aa = !0;
        "cell" === v && (7 < c || 7 < g) && !la && (la = !0,
        oa(),
        REDIPS.drag.event.moved(t));
        d > r[3] && d < J - r[1] && (k.style.left = d - r[3] + "px");
        e > r[0] && e < K - r[2] && (k.style.top = e - r[0] + "px");
        d < H[1] && d > H[3] && e < H[2] && e > H[0] && 0 === U && 0 === V && (q.containTable || d < q[3] || d > q[1] || e < q[0] || e > q[2]) && (T(),
        na());
        if (REDIPS.drag.scroll.enable)
            ...
            c = N()[0],
            P *= d < J / 2 ? -1 : 1,
            0 > P && 0 >= c || 0 < P && c >= ya - J || 0 !== U++ || (REDIPS.event.remove(window, "scroll", y),
            pa(window))) : P = 0,
            Q = b - (K / 2 > e ? e - r[0] : K - e - r[2]),
            0 < Q ? (Q > b && (Q = b),
            c = N()[1],
            Q *= e < K / 2 ? -1 : 1,
            0 > Q && 0 >= c || 0 < Q && c >= za - K || 0 !== V++ || (REDIPS.event.remove(window, "scroll", y),
            qa(window))) : Q = 0,
            g = 0; g < O.length; g++)
                if (c = O[g],
                c.autoscroll && d < c.offset[1] && d > c.offset[3] && e < c.offset[2] && e > c.offset[0]) {
                    R = b - (c.midstX > d ? d - r[3] - c.offset[3] : c.offset[1] - d - r[1]);
                    0 < R ? (R > b && (R = b),
                    R *= d < c.midstX ? -1 : 1,
                    0 === U++ && (REDIPS.event.remove(c.div, 
                    "scroll", y),
                    pa(c.div))) : R = 0;
                    S = b - (c.midstY > e ? e - r[0] - c.offset[0] : c.offset[2] - e - r[2]);
                    0 < S ? (S > b && (S = b),
                    S *= e < c.midstY ? -1 : 1,
                    0 === V++ && (REDIPS.event.remove(c.div, "scroll", y),
                    qa(c.div))) : S = 0;
                    break
                } else
                    R = S = 0;
    ...
    ;
    na = function() {
        l < f.length && (l !== x || h !== z || m !== E) && (null  !== x && null  !== z && null  !== E && (ba(x, z, E, ca),
        REDIPS.drag.td.previous = n.previous = f[x].rows[z].cells[E],
        REDIPS.drag.td.current = n.current = f[l].rows[h].cells[m],
        "switching" === REDIPS.drag.dropMode && "cell" === 
        v && (ia(n.current, n.previous),
        y(),
        T()),
        "cell" === v ? REDIPS.drag.event.changed(n.current) : "row" !== v || l === x && h === z || REDIPS.drag.event.rowChanged(n.current)),
        oa())
    }
    ;
    Ha = function() {
        "number" === typeof window.innerWidth ? (J = window.innerWidth,
        K = window.innerHeight) : document.documentElement && (document.documentElement.clientWidth || document.documentElement.clientHeight) ? (J = document.documentElement.clientWidth,
        K = document.documentElement.clientHeight) : document.body && (document.body.clientWidth || document.body.clientHeight) && 
    ...
    T = function() {
        ...
        for (l = 0; l < f.length; l++)
            if (!1 !== f[l].redips.enabled && (c[0] = f[l].redips.offset[0],
            c[1] = f[l].redips.offset[1],
            c[2] = f[l].redips.offset[2],
            c[3] = f[l].redips.offset[3],
            void 0 !== f[l].sca && (c[0] = c[0] > f[l].sca.offset[0] ? c[0] : f[l].sca.offset[0],
            c[1] = c[1] < f[l].sca.offset[1] ? 
            c[1] : f[l].sca.offset[1],
            ...
            c[3] < b && b < c[1] && c[0] < g && g < c[2])) {
                ...
                if (-1 === b.className.indexOf(REDIPS.drag.trash.className))
                    if (g = -1 < b.className.indexOf(REDIPS.drag.only.cname),
                    !0 === g) {
                    ...
                    (!0 === g && "deny" === REDIPS.drag.mark.action || !1 === g && "allow" === REDIPS.drag.mark.action) && -1 === b.className.indexOf(Ya.exception[k.id])) {
                        a();
                        break
                    }
    ...
    ;
    oa = function() {
        l < f.length && null  !== l && null  !== h && null  !== m && (ca = Ia(l, h, m),
        ba(l, h, m),
        x = l,
        z = h,
        E = m)
    ...
    ba = function(a, b, c, d) {
        if ("cell" === v && la)
            ...
            REDIPS.drag.hover.borderTd : (c.borderTopWidth = d.top[0][0],
            ...
            for (a = f[a].rows[b],
            b = 0; b < a.cells.length; b++)
                c = a.cells[b].style,
                c.backgroundColor = 
                void 0 === d ? REDIPS.drag.hover.colorTr : d.color[b].toString(),
                void 0 !== REDIPS.drag.hover.borderTr && (void 0 === d ? l === D ? h < L ? c.borderTop = REDIPS.drag.hover.borderTr : c.borderBottom = REDIPS.drag.hover.borderTr : "before" === REDIPS.drag.rowDropMode ? c.borderTop = REDIPS.drag.hover.borderTr : c.borderBottom = REDIPS.drag.hover.borderTr : (c.borderTopWidth = d.top[b][0],
    ...
    Ia = function(a, b, c) {
        ...
        if ("cell" === v)
            ...
            void 0 !== REDIPS.drag.hover.borderTd && (d.top[0] = e(c, "Top"),
            d.right[0] = e(c, "Right"),
    ...
    N = function() {
        var a, b;
        "number" === typeof window.pageYOffset ? (a = window.pageXOffset,
    ...
    pa = function(a) {
        ...
        0 < U && (y(),
        T(),
        b < H[1] && b > H[3] && c < H[2] && c > H[0] && na());
        "object" === typeof a && (w = a);
        w === window ? (a = N()[0],
        b = ya - J,
        c = P) : (a = w.scrollLeft,
        b = w.scrollWidth - w.clientWidth,
        c = R);
        0 < U && (0 > c && 0 < a || 0 < c && a < b) ? (w === window ? (window.scrollBy(c, 0),
        N(),
        a = parseInt(k.style.left, 
        10),
        isNaN(a)) : w.scrollLeft += c,
        setTimeout(pa, REDIPS.drag.scroll.speed)) : (REDIPS.event.add(w, "scroll", y),
        U = 0,
        q = [0, 0, 0, 0])
    }
    ;
    qa = function(a) {
        ...
        b = za - K,
        c = Q) : (a = w.scrollTop,
        b = w.scrollHeight - w.clientHeight,
        c = S);
        0 < V && (0 > c && 0 < a || 0 < c && a < b) ? (w === window ? (window.scrollBy(0, c),
        N(),
        a = parseInt(k.style.top, 10),
        isNaN(a)) : w.scrollTop += c,
        setTimeout(qa, REDIPS.drag.scroll.speed)) : (REDIPS.event.add(w, "scroll", 
        y),
        V = 0,
        q = [0, 0, 0, 0])
    }
    ...
    ra = function(a, b) {
        ...
        !0 === b && (document.getElementById("redips_clone").appendChild(c),
        c.style.zIndex = 999,
        c.style.position = "fixed",
        e = G(a),
        g = G(c),
    ...
    Ja = function(a, b) {
        ...
        c[1] = function(a, b) {
            a.redips && (b.redips = {},
            b.redips.emptyRow = a.redips.emptyRow)
        }
        ;
        d = function(d) {
            var g, f, A;
    ...
    sa = function(a, b) {
        ...
        10),
        c = parseInt(c[2], 10),
        0 === c && 1 === b && (e += " redips-clone",
        2 === d && F(!0, a)),
        c += b,
        e = e.replace(/climit\d_\d+/g, "climit" + d + "_" + c),
        0 >= c && (e = e.replace("redips-clone", ""),
        2 === d ? (F(!1, a),
        REDIPS.drag.event.clonedEnd2()) : REDIPS.drag.event.clonedEnd1()),
        a.className = xa(e))
    }
    ;
    Ka = function(a) {
        var b = !1;
        a.srcElement ? (b = a.srcElement.nodeName,
        a = a.srcElement.className) : (b = a.target.nodeName,
    ...
    F = function(a, b) {
        ...
        !0 === a || "init" === a ? (A = REDIPS.drag.style.borderEnabled,
        h = "move",
        l = !0) : (A = REDIPS.drag.style.borderDisabled,
        h = "auto",
        l = !1);
        ...
        for (d = c = 0; c < g.length; c++)
            if (n.test(g[c].className))
                "init" === 
                a || void 0 === g[c].redips ? (g[c].redips = {},
                g[c].redips.container = C) : !0 === a && "number" === typeof k ? (g[c].style.opacity = "",
                g[c].style.filter = "") : !1 === a && "number" === typeof k && (g[c].style.opacity = k / 100,
                g[c].style.filter = "alpha(opacity=" + k + ")"),
                Y(g[c], l),
                g[c].style.borderStyle = A,
                g[c].style.cursor = h,
                g[c].redips.enabled = l;
            else if ("init" === a && (e = I(g[c], "overflow"),
            "visible" !== e)) {
        ...
        d = function(a, b) {
            ...
            REDIPS.drag.moveObject({
                ...
                callback: function(a) {
                    ...
                    Ba[d]--;
                    0 === Ba[d] && (REDIPS.drag.event.relocateEnd(),
        ...
        if (a !== b && "object" === typeof a && "object" === typeof b)
            ...
            "animation" === c) {
                if (0 < g)
                    ...
                    c = 0; c < g; c++)
                        1 === a.childNodes[c].nodeType && "DIV" === a.childNodes[c].nodeName && (Ba[e]++,
                        d(a.childNodes[c], b))
            } else
                for (d = c = 0; c < g; c++)
                    1 === a.childNodes[d].nodeType && "DIV" === a.childNodes[d].nodeName ? (e = a.childNodes[d],
                    REDIPS.drag.event.relocateBefore(e, 
                    b),
                    b.appendChild(e),
    ...
    ja = function(a, b) {
        ...
        if ("TD" === a.nodeName) {
            ...
            if ("test" === b)
                return c = n.source === a ? void 0 : 0 === a.childNodes.length || 1 === a.childNodes.length && 3 === a.firstChild.nodeType;
            for (e = 0; e < c; e++)
                d.push(a.childNodes[0]),
    ...
    ta = function(a, b) {
        ...
        if (a !== b) {
            ...
            "vertical1" === f || "vertical2" === f ? (f = 1E3 * c[1] + c[0] < 1E3 * g[1] + g[0] ? 1 : -1,
            d = p,
            p = 0,
            r = 1) : (f = 1E3 * c[0] + c[1] < 1E3 * g[0] + g[1] ? 1 : -1,
            d = r,
            p = 1,
            r = 0);
            for (c[0] !== e[0] && c[1] !== e[1] && (t = !0); c[0] !== g[0] || c[1] !== g[1]; )
                h = k[c[0] + "-" + c[1]],
                c[p] += f,
                0 > c[p] ? (c[p] = d,
                c[r]--) : c[p] > d && (c[p] = 0,
                ...
                void 0 !== h && (m = h),
                void 0 !== e && void 0 !== m || 
                void 0 !== l && void 0 !== h ? (e = -1 === l.className.indexOf(REDIPS.drag.mark.cname) ? 0 : 1,
                h = -1 === m.className.indexOf(REDIPS.drag.mark.cname) ? 0 : 1,
                t && 0 === e && 1 === h && v(l),
                1 === e ? 0 === h && (q = m) : (0 === e && 1 === h && (m = q),
                u(l, m))) : t && void 0 !== l && void 0 === m && (e = -1 === l.className.indexOf(REDIPS.drag.mark.cname) ? 0 : 1,
                0 === e && v(l))
        }
    }
    ;
    ...
    Ma = function(a, b) {
        ...
        (4 - 3 * c) * b.direction;
        d = b.m * a + b.b;
        "horizontal" === b.type ? (b.obj.style.left = a + "px",
        b.obj.style.top = d + "px") : (b.obj.style.left = d + "px",
        b.obj.style.top = a + "px");
        a < b.last && 0 < b.direction || a > b.last && 0 > b.direction ? setTimeout(function() {
            Ma(a, b)
        }, REDIPS.drag.animation.pause * c) : (Ga(b.obj),
        b.obj.redips && (b.obj.redips.animated = !1),
        "cell" === b.mode ? (!0 === b.overwrite && ja(b.targetCell),
        b.targetCell.appendChild(b.obj),
        b.obj.redips && !1 !== b.obj.redips.enabled && Y(b.obj)) : Na(ua(b.target[0]), b.target[1], b.obj),
        "function" === 
    ...
    va = function(a) {
        ...
        b = c = d = -1;
        if (void 0 === a)
            b = l < f.length ? f[l].redips.idx : null  === x || null  === z || null  === E ? f[D].redips.idx : f[x].redips.idx,
            c = f[D].redips.idx,
            b = [b, h, m, c, L, X];
        else {
            if (a = "string" === typeof a ? document.getElementById(a) : a)
                "TD" !== a.nodeName && (a = B("TD", a)),
                a && "TD" === a.nodeName && (b = a.cellIndex,
    ...
    wa = function(a, b, c) {
        ...
        a = B("TABLE", a));
        if ("TR" === a.nodeName)
            for (a = a.getElementsByTagName("td"),
            d = 0; d < a.length; d++)
                if (a[d].style.backgroundColor = c ? c : "",
                "empty" === b)
                    a[d].innerHTML = "";
                else
                    for (e = 0; e < a[d].childNodes.length; e++)
                        1 === a[d].childNodes[e].nodeType && (a[d].childNodes[e].style.opacity = 
                        b / 100,
    ...
    return {
        ...
        init: function(a) {
            ...
            Ca = N();
            document.getElementById("redips_clone") || (a = document.createElement("div"),
            a.id = "redips_clone",
        ...
        saveContent: function(a, b) {
            ...
            if (void 0 !== a && "object" === typeof a && "TABLE" === a.nodeName) {
                d = a.rows.length;
                for (k = 0; k < d; k++)
                    for (e = a.rows[k].cells.length,
                    l = 0; l < e; l++)
                        if (f = a.rows[k].cells[l],
                        0 < f.childNodes.length)
                            for (m = 0; m < f.childNodes.length; m++)
                                h = f.childNodes[m],
                                "DIV" === h.nodeName && -1 < h.className.indexOf("redips-drag") && (c += p + "[]=" + h.id + "_" + k + "_" + l + "&",
                                n.push([h.id, k, l]));
        ...
        moveObject: function(a) {
            ...
            if ("row" === a.mode) {
                ...
                if (p.redips && !0 === p.redips.emptyRow)
                    return !1;
            ...
            if ("object" === typeof b.obj && null  !== b.obj)
                return b.obj.style.zIndex = 999,
                b.obj.redips && C !== b.obj.redips.container && (C = b.obj.redips.container,
                u()),
                h = G(b.obj),
                e = h[1] - h[3],
                g = h[2] - h[0],
                c = h[3],
                d = h[0],
                !0 === a.clone && "cell" === b.mode && (b.obj = ra(b.obj, !0),
                REDIPS.drag.event.cloned(b.obj)),
                void 0 === a.target ? a.target = va() : "object" === typeof a.target && "TD" === a.target.nodeName && (a.target = va(a.target)),
                b.target = a.target,
                h = ua(a.target[0]),
                k = a.target[1],
                a = a.target[2],
                k > f[h].rows.length - 
                1 && (k = f[h].rows.length - 1),
                b.targetCell = f[h].rows[k].cells[a],
                "cell" === b.mode ? (h = G(b.targetCell),
                k = h[1] - h[3],
                a = h[2] - h[0],
                e = h[3] + (k - e) / 2,
                g = h[0] + (a - g) / 2) : (h = G(f[h].rows[k]),
                e = h[3],
                g = h[0]),
                h = e - c,
                a = g - d,
                b.obj.style.position = "fixed",
                Math.abs(h) > Math.abs(a) ? (b.type = "horizontal",
                b.m = a / h,
                b.b = d - b.m * c,
                b.k1 = (c + e) / (c - e),
                b.k2 = 2 / (c - e),
